...
import com.mozaicgames.executors.CRequestExecutorUpdateUsageTime;
import com.mozaicgames.executors.CRequestExecutorUpdateUserGameData;
import com.mozaicgames.executors.CRequestExecutorUpdateUserSettings;
import com.mozaicgames.executors.CRequestExecutorUpdateUserWalletData;
...
public class Main 
{
	...
	public static void main(String[] args) 
	{
		...
		try 
        {
			...
			requestHandler.addRequestExecuter("update_user_settings_data", new CRequestExecutorUpdateUserSettings());
			requestHandler.addRequestExecuter("update_user_game_data", new CRequestExecutorUpdateUserGameData());
			requestHandler.addRequestExecuter("update_user_wallet_data", new CRequestExecutorUpdateUserWalletData());
			...
			requestHandler.addRequestExecuter("update_usage_time", new CRequestExecutorUpdateUsageTime());
        }
		catch (Exception e)
		{
