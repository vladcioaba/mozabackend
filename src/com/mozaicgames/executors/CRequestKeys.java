...
public class CRequestKeys 
{
	...
	public static final String mKeyUserDataMagnetOn			= "userdata_magnet_on";
	public static final String mKeyUserDataLeftHandedOn		= "userdata_lefthanded_on";
	public static final String mKeyUserDataMusicOn			= "userdata_music_on";
	public static final String mKeyUserDataSfxOn			= "userdata_sfx_on";
	public static final String mKeyUserDataCredits			= "userdata_credits";
